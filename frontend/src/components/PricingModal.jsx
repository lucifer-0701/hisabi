...
const plans = [
    ...
    },
    {
        ...
        badge: 'Recommended',
        features: ['Advanced analytics', 'Best Selling Products', 'Advanced Dashboard Widgets', 'Export reports (CSV/PDF)'],
        cta: 'Upgrade to Gold',
        disabled: false,
        style: 'gold',
        icon: Crown,
    },
    {
        ...
        features: ['Everything in Gold', 'Custom Analytics Suite', 'Priority support', 'Custom branding'],
...
const PricingModal = ({ isOpen, onClose }) => {
    ...
    const handleUpgrade = async (planName) => {
        ...
        try {
            const response = await api.post('/subscription/upgrade', { plan: planName });
            ...
            // Success feedback could go here, but for now just close or show success
            setTimeout(() => {
                setUpgrading(null);
                onClose();
            }, 500);
